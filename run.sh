...
export HF_AUTH_TOKEN="hf_aXx vHXOjhAJuqltKOPokqbfWapvwrIzCDt"


python3 -m bert_routing.main  --model_name tinybert  --num_epochs 5 --batch_size 16 --context_window 512 --data_size None --strategy cls
# python3 test.py
